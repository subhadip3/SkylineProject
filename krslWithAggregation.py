...
from aggregation import my_func
 ...
 #   print(heap)
  ...
  #                  print(dominate_value)
   ...
   #            print(global_skyline)
		...
		#print("Rectangle")		
		#print(rectangle);
                is_reverse_skyline=1
                #print("Sending check for rectangle corresponding to ",first_item[2]) 
                comp_count=[] 
	        comp_count.append(0);
                is_reverse_skyline=my_func(s,rectangle,q,records_modified,first_item[2],comp_count) 
...
records=[[1,1,1.5,1],[2,4,4,4],[3,2,2,2],[4,2,5,1]]
root=[]
q=[3,3,3]
for temp in records:
    rtree_insert(temp)
...
bbrs(root,q,2,records)
print(global_skyline)
print(reverse_skyline)
print(k_reverse_skyline)
